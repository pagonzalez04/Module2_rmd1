...
Here is a link to \href{http://google.com.mx}{GOOGLE}
...
\includegraphics{module2_rmd1_files/figure-latex/pressure 2-1.pdf}
...
\hypertarget{insert-and-ecuation}{%
\subsection{Insert and ecuation}\label{insert-and-ecuation}}
...
\hypertarget{insert-an-animated-git-and-video}{%
\subsection{Insert an Animated GIT and
video}\label{insert-an-animated-git-and-video}}
...
\hypertarget{insert-text-with-footnote}{%
\subsection{Insert text with footnote}\label{insert-text-with-footnote}}
...
Here is an inline footnote \footnote{inline notes are easier to write,
  since you don't have to pick an identified and move downl to type the
  note}
